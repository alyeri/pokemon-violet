...
//
// The current ES256 shape has not yet been validated against traffic from Violet:
//   header  {"alg":"ES256","jku":"jwkSets/nplnAccessToken","kid":"<uuid>"}
//   payload {"exp":..., "iat":..., "iss":"default iss", "sub":"u-...",
//            "npln":{"aid":"a-...","app_id":"01008F6008C5E000",
//                    "authorization":{"allow":["**"],"deny":[],"nso_restricted":false},
//                    "ext_id":"...","ext_id_type":1,"tid":"t-50e39f8f-lp1"}}
...
func nplnSigningKey() (*ecdsa.PrivateKey, string) {
	jwtOnce.Do(func() {
		jwtKID = "50e39f8f-violet-4992-80bf-5f289ebbf566"
		path := envOr("NPLN_JWT_KEY", "npln_jwt_violet_es256.key")
