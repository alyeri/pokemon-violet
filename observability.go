...
// observability records the evidence needed to evaluate a Violet connection
...
func (s *observedServerStream) SendMsg(message any) error {
	...
	if err == nil {
		violetProbe.captureMessage(s.Context(), "out", s.method, message)
	} else {
